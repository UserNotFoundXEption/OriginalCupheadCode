...
public class ClownLevelClownHorse : LevelProperties.Clown.Entity
{
	...
	// (get) Token: 0x060013AA RID: 5034 RVA: 0x000107FF File Offset: 0x0000E9FF
	// (set) Token: 0x060013AB RID: 5035 RVA: 0x00010807 File Offset: 0x0000EA07
	public ClownLevelClownHorse.HorseType horseType { get; set; }

	// Token: 0x060013AC RID: 5036 RVA: 0x000983DC File Offset: 0x000965DC
	...
	// Token: 0x060013AD RID: 5037 RVA: 0x00010810 File Offset: 0x0000EA10
	...
	// Token: 0x060013AE RID: 5038 RVA: 0x00010848 File Offset: 0x0000EA48
	...
	// Token: 0x060013AF RID: 5039 RVA: 0x00010866 File Offset: 0x0000EA66
	public void Update()
	{
	...
	// Token: 0x060013B0 RID: 5040 RVA: 0x0009844C File Offset: 0x0009664C
	public void StartCarouselHorse()
	{
		...
		this.dropMainIndex = Random.Range(0, horse.DropBulletPositionString.Length);
		this.pinkMainIndex = Random.Range(0, horse.WavePinkString.Length);
		this.horseTypePattern = horse.HorseString.GetRandom<string>().Split(new char[]
		{
			','
		});
		this.horseTypeIndex = Random.Range(0, this.horseTypePattern.Length);
		...
		this.dropBulletIndex = Random.Range(0, this.dropBulletPositionPattern.Length);
		this.StopAllCoroutines();
		base.StartCoroutine(this.select_horse_cr());
	}

	// Token: 0x060013B1 RID: 5041 RVA: 0x0001087E File Offset: 0x0000EA7E
	...
	// Token: 0x060013B2 RID: 5042 RVA: 0x0001089A File Offset: 0x0000EA9A
	...
	// Token: 0x060013B3 RID: 5043 RVA: 0x00098594 File Offset: 0x00096794
	public IEnumerator select_horse_cr()
	{
		...
		{
			Debug.LogError("Horse Type Pattern is messed up!", null);
		}
	...
	// Token: 0x060013B4 RID: 5044 RVA: 0x000985B0 File Offset: 0x000967B0
	public IEnumerator horse_cr(ClownLevelClownHorse.HorseType horseType, string[] positionPattern, float ATKAmount)
	{
		bool isPink = false;
		float hesitate = 0f;
		float posOffset = 0f;
	...
	// Token: 0x060013B5 RID: 5045 RVA: 0x000985E0 File Offset: 0x000967E0
	public IEnumerator spit_fx_cr()
	{
	...
	// Token: 0x060013B6 RID: 5046 RVA: 0x000985FC File Offset: 0x000967FC
	...
	// Token: 0x060013B7 RID: 5047 RVA: 0x000108BE File Offset: 0x0000EABE
	public void SpitSFX()
	{
	...
	// Token: 0x060013B8 RID: 5048 RVA: 0x000986E8 File Offset: 0x000968E8
	public void FireWaveBullets(int index, bool isPink, float YSpeed, Vector3 pos)
	{
		LevelProperties.Clown.Horse horse = base.properties.CurrentState.horse;
		bool onRight = base.transform.position.x > 0f;
		if (isPink)
		{
			ClownLevelHorseshoe clownLevelHorseshoe = Object.Instantiate<ClownLevelHorseshoe>(this.pinkHorseshoe);
			clownLevelHorseshoe.Init(pos, horse.WaveBulletSpeed, YSpeed, onRight, 0f, horse, ClownLevelClownHorse.HorseType.Wave);
		}
		else
		{
			ClownLevelHorseshoe clownLevelHorseshoe2 = Object.Instantiate<ClownLevelHorseshoe>(this.regularHorseshoe);
			clownLevelHorseshoe2.Init(pos, horse.WaveBulletSpeed, YSpeed, onRight, 0f, horse, ClownLevelClownHorse.HorseType.Wave);
		}
	}

	// Token: 0x060013B9 RID: 5049 RVA: 0x00098788 File Offset: 0x00096988
	public void FireDropBullets(float spawnY, float durationBeforeDrop)
	{
		LevelProperties.Clown.Horse horse = base.properties.CurrentState.horse;
		bool onRight = this.projectileRoot.transform.position.x > 0f;
		ClownLevelHorseshoe clownLevelHorseshoe = Object.Instantiate<ClownLevelHorseshoe>(this.regularHorseshoe);
	...
	// Token: 0x060013BA RID: 5050 RVA: 0x000108DA File Offset: 0x0000EADA
	...
	// Token: 0x060013BB RID: 5051 RVA: 0x00098804 File Offset: 0x00096A04
	public IEnumerator horse_death_cr()
	{
		float t = 0f;
		float time = 3f;
		...
		Object.Destroy(this.clownHorseHead.GetComponent<HitFlash>());
		yield return CupheadTime.WaitForSeconds(this, 1f);
		...
		while (t < time)
		{
			...
			{
				float num = EaseUtils.Ease(EaseUtils.EaseType.linear, 0f, 1f, t / time);
				this.moveObject.transform.position = Vector2.Lerp(this.moveObject.transform.position, this.startPos, num);
				t += CupheadTime.Delta;
			}
			yield return null;
		}
		this.moveObject.transform.position = this.startPos;
		Object.Destroy(this.moveObject.gameObject);
		yield return null;
		yield break;
	}

	// Token: 0x060013BC RID: 5052 RVA: 0x000108EF File Offset: 0x0000EAEF
	...
	// Token: 0x060013BD RID: 5053 RVA: 0x00098820 File Offset: 0x00096A20
	public IEnumerator clown_fall_cr()
	{
	...
	// Token: 0x060013C1 RID: 5057 RVA: 0x00098894 File Offset: 0x00096A94
	public IEnumerator move_to_death_spot_cr()
	{
		float t = 0f;
		float time = 1f;
	...
	// Token: 0x060013C2 RID: 5058 RVA: 0x00010937 File Offset: 0x0000EB37
	public void FallHorseSFX()
	{
		AudioManager.Play("clown_horse_death_slide");
	}

	// Token: 0x060013C3 RID: 5059 RVA: 0x00010943 File Offset: 0x0000EB43
	public void FallHorseScreamSFX()
	{
	...
	// Token: 0x060013C4 RID: 5060 RVA: 0x00010961 File Offset: 0x0000EB61
	public void FallHorseSFXOff()
	{
	...
	[SerializeField]
	public GameObject clownHorseBody;

	// Token: 0x04000FF1 RID: 4081
	[SerializeField]
	public GameObject clownHorseHead;
	...
	[SerializeField]
	public ClownLevelHorseshoe regularHorseshoe;

	// Token: 0x04000FF5 RID: 4085
	[SerializeField]
	public ClownLevelHorseshoe pinkHorseshoe;

	// Token: 0x04000FF6 RID: 4086
	[SerializeField]
	public Effect spitFxPrefabA;

	// Token: 0x04000FF7 RID: 4087
	[SerializeField]
	public Effect spitFxPrefabB;

	// Token: 0x04000FF8 RID: 4088
	[SerializeField]
	public Transform spitFxRoot;
	...
	public string[] horseTypePattern;

	// Token: 0x04000FFF RID: 4095
	public string[] wavePositionPattern;

	// Token: 0x04001000 RID: 4096
	public string[] wavePinkPattern;

	// Token: 0x04001001 RID: 4097
	public string[] dropPositionPattern;

	// Token: 0x04001002 RID: 4098
	public string[] dropBulletPositionPattern;
	...
	public int dropBulletIndex;

	// Token: 0x04001006 RID: 4102
	public int horseTypeIndex;

	// Token: 0x04001007 RID: 4103
	public int dropMainIndex;

	// Token: 0x04001008 RID: 4104
	public int pinkMainIndex;

	// Token: 0x04001009 RID: 4105
	public bool droppedClown;

	// Token: 0x0400100A RID: 4106
	public bool ScreamSFXPlaying;
