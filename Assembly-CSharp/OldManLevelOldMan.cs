...
public class OldManLevelOldMan : LevelProperties.OldMan.Entity
{
	...
	// (get) Token: 0x06002085 RID: 8325 RVA: 0x0001BA2F File Offset: 0x00019C2F
	// (set) Token: 0x06002086 RID: 8326 RVA: 0x0001BA37 File Offset: 0x00019C37
	public OldManLevelOldMan.State state { get; set; }

	// Token: 0x06002087 RID: 8327 RVA: 0x0001BA40 File Offset: 0x00019C40
	public void Start()
	{
	...
	// Token: 0x06002088 RID: 8328 RVA: 0x0001BA7C File Offset: 0x00019C7C
	public void Update()
	{
	...
	// Token: 0x06002089 RID: 8329 RVA: 0x0001BA94 File Offset: 0x00019C94
	public void OnDamageTaken(DamageDealer.DamageInfo info)
	{
		base.properties.DealDamage(info.damage);
	}

	// Token: 0x0600208A RID: 8330 RVA: 0x000B8700 File Offset: 0x000B6900
	public override void LevelInit(LevelProperties.OldMan properties)
	{
		...
		this.spitStringMainIndex = Random.Range(0, spitAttack.spitString.Length);
		this.gooseSpawnString = new PatternString(properties.CurrentState.gooseAttack.gooseSpawnString, ':', true, true);
		base.StartCoroutine(this.intro_cr());
	}

	// Token: 0x0600208B RID: 8331 RVA: 0x000B8760 File Offset: 0x000B6960
	...
	// Token: 0x0600208C RID: 8332 RVA: 0x0001BAA7 File Offset: 0x00019CA7
	public void AniEvent_CameraRumble()
	{
		CupheadLevelCamera.Current.Shake(5f, 0.66f, false);
	}

	// Token: 0x0600208D RID: 8333 RVA: 0x0001BABE File Offset: 0x00019CBE
	public void AniEvent_CameraShake()
	{
		CupheadLevelCamera.Current.Shake(30f, 1.2f, false);
	}

	// Token: 0x0600208E RID: 8334 RVA: 0x0001BAD5 File Offset: 0x00019CD5
	public void ChangeColor(Color color)
	{
		this.sprite.color = color;
	}

	// Token: 0x0600208F RID: 8335 RVA: 0x0001BAE3 File Offset: 0x00019CE3
	public void Spit()
	{
		base.StartCoroutine(this.spit_cr());
	}

	// Token: 0x06002090 RID: 8336 RVA: 0x000B877C File Offset: 0x000B697C
	public IEnumerator spit_cr()
	{
		...
		for (int i = 0; i < spitString.Length; i++)
		{
			...
			startPosition = this.spitRoot.transform.position + Vector3.right * (float)Random.Range(-15, 15);
	...
	// Token: 0x06002091 RID: 8337 RVA: 0x0001BAF2 File Offset: 0x00019CF2
	public void Goose()
	{
		base.StartCoroutine(this.Goose_cr());
	}

	// Token: 0x06002092 RID: 8338 RVA: 0x000B8798 File Offset: 0x000B6998
	public IEnumerator Goose_cr()
	{
		...
		while (spawningGeese && !this.endPhaseOne)
		{
			...
			if (geeseDelayTimer >= geeseDelayMaxTime)
			{
				...
				Vector3 vector;
				vector..ctor(xPos, this.gooseSpawnString.GetSubsubstringFloat(2));
	...
	// Token: 0x06002093 RID: 8339 RVA: 0x0001BB01 File Offset: 0x00019D01
	public void Bear()
	{
		base.StartCoroutine(this.bear_cr());
	}

	// Token: 0x06002094 RID: 8340 RVA: 0x000B87B4 File Offset: 0x000B69B4
	public IEnumerator bear_cr()
	{
		...
		base.animator.SetTrigger(OldManLevelOldMan.ContinueParameterID);
		t = 0f;
		yield return base.animator.WaitForNormalizedTime(this, 1.29166663f, "Bear_Atk_Cont", 0, false, false, true);
	...
	// Token: 0x06002095 RID: 8341 RVA: 0x000B87D0 File Offset: 0x000B69D0
	public IEnumerator exit_bear_cr()
	{
		Animator bearAni = this.bearBeam.GetComponent<Animator>();
		base.animator.SetBool(OldManLevelOldMan.IsBearAttackParameterID, false);
	...
	// Token: 0x06002096 RID: 8342 RVA: 0x0001BB10 File Offset: 0x00019D10
	...
	// Token: 0x06002097 RID: 8343 RVA: 0x0001BB2A File Offset: 0x00019D2A
	public void AniEvent_EndPhase1BeardBoil()
	{
		this.rightWall.SetActive(false);
		base.animator.Play("None", 1);
	}

	// Token: 0x06002098 RID: 8344 RVA: 0x0001BB49 File Offset: 0x00019D49
	public void AniEvent_ActivatePhase2Beard()
	{
		((OldManLevel)Level.Current).ActivatePhase2Beard();
		base.GetComponent<SpriteRenderer>().sortingOrder = -1;
	}

	// Token: 0x06002099 RID: 8345 RVA: 0x0001BB66 File Offset: 0x00019D66
	...
	// Token: 0x0600209A RID: 8346 RVA: 0x0001BB7E File Offset: 0x00019D7E
	public void animationEvent_PlayGooseFX()
	{
		this.gooseFXAnimator.Play("FX");
	}

	// Token: 0x0600209B RID: 8347 RVA: 0x0001BB90 File Offset: 0x00019D90
	public void animationEvent_IdleBlinkStart()
	{
	...
	// Token: 0x0600209C RID: 8348 RVA: 0x0001BBB8 File Offset: 0x00019DB8
	public void animationEvent_IdleBlinkEnd()
	{
		this.eyeRenderer.enabled = false;
	}

	// Token: 0x0600209D RID: 8349 RVA: 0x0001BBC6 File Offset: 0x00019DC6
	public void animationEvent_BeginCauldron()
	{
		this.cauldron.SetActive(true);
	}

	// Token: 0x0600209E RID: 8350 RVA: 0x0001BBD4 File Offset: 0x00019DD4
	public void animationEvent_EndCauldron()
	{
		this.cauldron.SetActive(false);
	}

	// Token: 0x0600209F RID: 8351 RVA: 0x0001BBE2 File Offset: 0x00019DE2
	public void animationEvent_BeginSpitEyes()
	{
		this.cauldronEyes.SetActive(true);
	}

	// Token: 0x060020A0 RID: 8352 RVA: 0x0001BBF0 File Offset: 0x00019DF0
	public void animationEvent_EndSpitEyes()
	{
		this.cauldronEyes.SetActive(false);
	}

	// Token: 0x060020A1 RID: 8353 RVA: 0x0001BBFE File Offset: 0x00019DFE
	public void AnimationEvent_SFX_OMM_Intro()
	{
		AudioManager.Play("sfx_dlc_omm_intro");
		this.emitAudioFromObject.Add("sfx_dlc_omm_intro");
	}

	// Token: 0x060020A2 RID: 8354 RVA: 0x0001BC1A File Offset: 0x00019E1A
	public void AnimationEvent_SFX_OMM_IntroPickaxe()
	{
		AudioManager.Play("sfx_dlc_omm_intropickaxe");
		this.emitAudioFromObject.Add("sfx_dlc_omm_intropickaxe");
	}

	// Token: 0x060020A3 RID: 8355 RVA: 0x0001BC36 File Offset: 0x00019E36
	public void AnimationEvent_SFX_OMM_GooseStormIntro()
	{
		AudioManager.Play("sfx_dlc_omm_goosestorm");
		this.emitAudioFromObject.Add("sfx_dlc_omm_goosestorm");
	}

	// Token: 0x060020A4 RID: 8356 RVA: 0x0001BC52 File Offset: 0x00019E52
	public void AnimationEvent_SFX_OMM_GooseStormLoop()
	{
		base.StartCoroutine(this.SFX_OMM_GooseStormLoop_cr());
	}

	// Token: 0x060020A5 RID: 8357 RVA: 0x000B87EC File Offset: 0x000B69EC
	public IEnumerator SFX_OMM_GooseStormLoop_cr()
	{
	...
	// Token: 0x060020A6 RID: 8358 RVA: 0x0001BC61 File Offset: 0x00019E61
	public void AnimationEvent_SFX_OMM_GooseStormLoopEnd()
	{
	...
	// Token: 0x060020A7 RID: 8359 RVA: 0x0001BC87 File Offset: 0x00019E87
	public void AnimationEvent_SFX_OMM_MouthCauldron_MouthClose()
	{
	...
	// Token: 0x060020A8 RID: 8360 RVA: 0x000B8808 File Offset: 0x000B6A08
	public void AnimationEvent_SFX_OMM_MouthCauldron_MouthOpen()
	{
	...
	// Token: 0x060020A9 RID: 8361 RVA: 0x0001BCAD File Offset: 0x00019EAD
	public void AnimationEvent_SFX_OMM_BearAttackOMMStartVocal()
	{
		AudioManager.Play("sfx_dlc_omm_bearattack_ommstartvocal");
		this.emitAudioFromObject.Add("sfx_dlc_omm_bearattack_ommstartvocal");
	}

	// Token: 0x060020AA RID: 8362 RVA: 0x0001BCC9 File Offset: 0x00019EC9
	public void AnimationEvent_SFX_OMM_BearAttackStart()
	{
		AudioManager.Play("sfx_dlc_omm_bearattack_start");
		this.emitAudioFromObject.Add("sfx_dlc_omm_bearattack_start");
	}

	// Token: 0x060020AB RID: 8363 RVA: 0x0001BCE5 File Offset: 0x00019EE5
	public void AnimationEvent_SFX_OMM_P2_OMMVocalFrustrated()
	{
	...
	// Token: 0x060020AC RID: 8364 RVA: 0x0001BD01 File Offset: 0x00019F01
	public void AnimationEvent_SFX_OMM_P2_TransitionBeardPull()
	{
	...
	public static readonly int IsSpitAttackParameterID = Animator.StringToHash("IsSpitAttack");

	// Token: 0x04001AB3 RID: 6835
	public static readonly int IsSpitAttackEyeLoopParameterID = Animator.StringToHash("IsSpitAttackEyeLoop");

	// Token: 0x04001AB4 RID: 6836
	public static readonly int IsGooseAttackParameterID = Animator.StringToHash("IsGooseAttack");

	// Token: 0x04001AB5 RID: 6837
	public static readonly int ContinueParameterID = Animator.StringToHash("Continue");

	// Token: 0x04001AB6 RID: 6838
	public static readonly int IsBearAttackParameterID = Animator.StringToHash("IsBearAttack");

	// Token: 0x04001AB7 RID: 6839
	public const float DUCK_MOVE_END = -165f;

	// Token: 0x04001AB8 RID: 6840
	public const float BEAR_START_X = -1300f;

	// Token: 0x04001AB9 RID: 6841
	public const float BEAR_Y = 100f;

	// Token: 0x04001ABA RID: 6842
	[SerializeField]
	public OldManLevelGoose goosePrefab;

	// Token: 0x04001ABB RID: 6843
	[SerializeField]
	public OldManLevelBear bearBeam;
	...
	[SerializeField]
	public Transform spitEndArc;

	// Token: 0x04001ABE RID: 6846
	[SerializeField]
	public OldManLevelSpitProjectile spitProjectile;

	// Token: 0x04001ABF RID: 6847
	[SerializeField]
	public OldManLevelSpitProjectile spitProjectilePink;
	...
	[SerializeField]
	public OldManLevelSockPuppetHandler sockPuppets;
	...
	[SerializeField]
	public GameObject cauldronEyes;

	// Token: 0x04001AC5 RID: 6853
	[SerializeField]
	public Animator gooseFXAnimator;
	...
	public int spitStringMainIndex;

	// Token: 0x04001ACC RID: 6860
	public bool shouldIdleBlink;

	// Token: 0x04001ACD RID: 6861
	public bool endPhaseOne;

	// Token: 0x04001ACE RID: 6862
	public PatternString gooseSpawnString;
