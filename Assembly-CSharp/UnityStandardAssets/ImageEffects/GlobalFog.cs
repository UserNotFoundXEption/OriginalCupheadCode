...
namespace UnityStandardAssets.ImageEffects
{
	...
	{
		// Token: 0x060047E9 RID: 18409 RVA: 0x000391DE File Offset: 0x000373DE
		...
		// Token: 0x060047EA RID: 18410 RVA: 0x001617B0 File Offset: 0x0015F9B0
		[ImageEffectOpaque]
		public void OnRenderImage(RenderTexture source, RenderTexture destination)
		{
			...
			Vector3 vector = transform.right * nearClipPlane * Mathf.Tan(num * 0.0174532924f) * aspect;
			Vector3 vector2 = transform.up * nearClipPlane * Mathf.Tan(num * 0.0174532924f);
		...
		// Token: 0x060047EB RID: 18411 RVA: 0x00161B6C File Offset: 0x0015FD6C
